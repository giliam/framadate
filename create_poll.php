...
if ($goToStep2) {
    ...
    $onlyOneChoice = isset($_POST['onlyOneChoice']) ? $inputService->filterBoolean($_POST['onlyOneChoice']) : false;
    ...
    $_SESSION['form']->onlyOneChoice = $onlyOneChoice;
...
$smarty->assign('poll_onlyOneChoice', Utils::fromPostOrDefault('onlyOneChoice', $_SESSION['form']->onlyOneChoice));
